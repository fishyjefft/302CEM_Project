<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site1.Master" Title="Home - EValley Shopping" CodeBehind="Default.aspx.cs" Inherits="WebApplication1.Default" %>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-3">
          ...
          <h3 class="my-4">Recommendations</h3>
          <div class="list-group">
            <a href="#" class="list-group-item">Entertainment</a>
            <a href="#" class="list-group-item">Fashions</a>
